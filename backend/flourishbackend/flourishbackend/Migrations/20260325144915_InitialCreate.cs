        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BabyFullName = table.Column<string>(type: "TEXT", nullable: true),
                    BabyDateOfBirth = table.Column<string>(type: "TEXT", nullable: true),
                    BabyGender = table.Column<string>(type: "TEXT", nullable: true),
