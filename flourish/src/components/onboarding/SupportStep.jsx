      ...
      {!showForm ? (
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm space-y-5">
          <div className="space-y-2">
            <p className="text-sm font-medium text-[#4A4458]">Type of Support</p>
          ...
          <div className="space-y-2">
            <label htmlFor="support_phone" className="text-sm text-[#7D7589]">
          ...
          <div className="pt-4 space-y-4">
            <p className="text-sm font-medium text-[#4A4458]">What would you like to share?</p>
            
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label htmlFor="share_journals" className="text-sm text-[#7D7589]">Journals</label>
                <Switch
                  id="share_journals"
              ...
              <div className="flex items-center justify-between">
                <label htmlFor="share_mood" className="text-sm text-[#7D7589]">Mood</label>
                <Switch
                  id="share_mood"
              ...
              <div className="flex items-center justify-between">
                <label htmlFor="share_baby_tracking" className="text-sm text-[#7D7589]">Baby Tracking</label>
                <Switch
