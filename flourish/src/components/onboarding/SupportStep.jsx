        ...
        <div className="space-y-6">
            ...
            {!showForm ? (
                ...
                <div className="bg-white rounded-3xl p-6 shadow-sm space-y-5">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {supportTypes.map((type) => (
                                <button
                                    ...
                                    type="button"
                                    onClick={() =>
                                        setFormData({ ...formData, support_type: type.value })
                                    }
                    ...
                    <div className="space-y-2">
                        <label htmlFor="support_name" className="text-sm font-medium text-[#4A4458]">
                            Full Name
                        </label>
                        <Input
                            id="support_name"
                            ...
                            onChange={(e) =>
                                setFormData({ ...formData, support_name: e.target.value })
                            }
                    ...
                    <div className="space-y-2">
                        <label htmlFor="support_email" className="text-sm font-medium text-[#4A4458]">
                            Email
                        </label>
                        <Input
                            id="support_email"
                    ...
                    <div className="pt-4 space-y-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <Label htmlFor="share_journals" className="text-[#5A4B70]">
                                    Journals
                                </Label>
                                <Switch
                                    id="share_journals"
                                    ...
                                    onCheckedChange={(checked) =>
                                        setFormData({ ...formData, share_journals: checked })
                                    }
                            ...
                            <div className="flex items-center justify-between">
                                <Label htmlFor="share_mood" className="text-[#5A4B70]">
                                    Mood
                                </Label>
                                <Switch
                                    id="share_mood"
                                    ...
                                    onCheckedChange={(checked) =>
                                        setFormData({ ...formData, share_mood: checked })
                                    }
                                    className="data-[state=checked]:bg-[#8B7A9F]"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                <Label htmlFor="share_baby_tracking" className="text-[#5A4B70]">
                                    Baby Tracking
                                </Label>
                                <Switch
