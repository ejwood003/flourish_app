        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 shadow-sm space-y-5">
                <div className="space-y-2">
                    <label htmlFor="baby_full_name" className="text-sm font-medium text-[#4A4458]">
                        Baby&apos;s Full Name
                    </label>
                    <Input
                        id="baby_full_name"
                        ...
                        onChange={(e) =>
                            setFormData({ ...formData, baby_full_name: e.target.value })
                        }
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {genderOptions.map((option) => (
                            <button
                                ...
                                type="button"
                                onClick={() =>
                                    setFormData({ ...formData, baby_gender: option.value })
                                }
