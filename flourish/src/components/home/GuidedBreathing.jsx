...
export default function GuidedBreathing({ onClose }) {
    ...
    return (
        ...
        >
            {/* Close Button  */}
            <button onClick={onClose} className="absolute top-6 right-6 p-2 bg-white/20 backdrop-blur-sm rounded-full text-[#4A4458] hover:bg-white/30 transition-colors">
                <X className="w-6 h-6" />
            </button>
            ...
            <div className="flex flex-col items-center">
                ...
                {/* Current Phase Indicator (breathe in, hold, out)  */}
                <motion.p
                    key={phase}
