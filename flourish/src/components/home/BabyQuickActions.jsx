    ...
    const BABY_MOOD_CHIPS = [
    'Calm', 'Happy', 'Fussy', 'Sleepy', 'Playful', 'Cranky', 'Content', 'Alert'
    ];
    ...
    return (
        ...
        <div className="grid grid-cols-3 gap-3">
            ...
            className={`p-4 rounded-2xl flex flex-col items-center justify-center gap-2 transition-all ${
                ...
                : 'bg-gradient-to-br from-[#F5E6EA] to-[#EDD9E8] text-[#4A4458] hover:shadow-md'
            }`}
            >
            ...
            className={`p-4 rounded-2xl flex flex-col items-center justify-center gap-2 transition-all ${
                ...
                : 'bg-gradient-to-br from-[#D9EEF2] to-[#E8E4F3] text-[#4A4458] hover:shadow-md'
            }`}
            >
            ...
            className="p-4 rounded-2xl flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-[#E8E4F3] to-[#F5E6EA] text-[#4A4458] hover:shadow-md transition-all"
            >
        ...
        {/* Feeding Form */}
        {showFeedingForm && (
            <div className="mt-4 p-4 bg-[#F5EEF8] rounded-2xl space-y-3">
        ...
        {/* Mood Entry Form */}
        {showMoodEntry && (
            <div className="mt-4 p-4 bg-[#F5EEF8] rounded-2xl space-y-4">
            ...
            <div className="space-y-2">
                ...
                onChange={(e) => setMoodData({ ...moodData, mood_value: parseInt(e.target.value) })}
                className="w-full h-2 bg-gradient-to-r from-[#B8A5C4] via-[#E8E4F3] to-[#A8D5BA] rounded-full appearance-none cursor-pointer"
                />
                <p className="text-center text-sm text-[#7D7589]">{moodData.mood_value}/100</p>
            </div>

            <div className="space-y-2">
                <p className="text-xs text-[#7D7589]">Add mood tags:</p>
