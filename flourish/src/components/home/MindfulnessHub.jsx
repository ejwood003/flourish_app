// Card that has meditation, guided breathing and journaling quick access buttons
...
// Variables needed for user to select the meditation type/time
...
export default function MindfulnessHub({ onBreathingStart }) {
    ...
    // set up links for when they select a meditation
    ...
    return (
        <>
            {/* The Buttons that show on the home page  */}
            <div className="bg-white rounded-3xl p-6 shadow-sm">
                ...
                <div className="grid grid-cols-3 gap-3">
                    ...
                    <button
                        ...
                        <span className="text-xs font-medium text-[#4A4458]">
                            Meditation
                        </span>
                    </button>
            ...
            {/* Code for the Meditation Type/Time Selection  */}
            <Dialog
